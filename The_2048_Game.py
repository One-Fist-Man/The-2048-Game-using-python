...
#add a new 2 or 4 tile randomly to an empty cell
    ...
    def game_over(self):
        ...
        elif not any(0 in row for row in self.matrix) and not self.horizontal_move_exists() and not self.vartical_move_exists():
            game_over_frame = tk.Frame(self.main_grid,borderwidth=2)
            game_over_frame.place(relx=0.5,rely=0.5,anchor="center")
            tk.Label(
                game_over_frame,
